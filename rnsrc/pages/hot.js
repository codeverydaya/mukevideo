            ...
            >
                ...
                <View style={{flexWrap:'wrap',flexDirection:'row',width:Util.getWidth()}}>
                    ...
                    { this.state.data.map((item,i)=> {
                        ...
                        return (
                            <TouchableOpacity onPress={()=>{NavigatorUtil.pushPage('Video',{videodata:VideoData[picNum]})}} key={i} style={{marginBottom:1,width: width+(i%3==1?2:0),backgroundColor:'#fff',height:height, justifyContent: 'center', alignItems: 'center',
                            }}>
